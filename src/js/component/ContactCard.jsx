...
const ContactCard = ({ contact }) => {
  ...
  return (
    <div className='container text-center mt-5' key={contact.id}>
        {/* <Link to="/AddContact">
	...
	<div className="card col-10">
		<div className="row g-0">
			...
			<div className="col-5 mt-4 text-start text-secondary">
				...
				<h2 className="text-decoration-underline"> {contact.nombre} </h2>
				...
				33 23.5 56.5T480-520ZM200-80v-80h560v80H200Zm280-520Z"/></svg>{contact.ubicacion}</p>
				...
				27t81.5 13v-88l-94-19-67 67ZM241-600Zm358 358Z"/></svg> {contact.telefono}</p>
				...
				320-200H160l320 200ZM160-640v-80 480-400Z"/></svg> {contact.email}</p>
			</div>
			...
			<button type="button" onClick={handleDelete} className="btn btn-light m-2"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path 

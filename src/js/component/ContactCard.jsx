	...
	<div className="card col-10 bg-light">
		<div className="row g-0">
			...
			<div className="col-5 mt-4 text-start text-secondary">
				...
				<h2 className="text-decoration-underline"> {contact.name} </h2>
				...
				33 23.5 56.5T480-520ZM200-80v-80h560v80H200Zm280-520Z"/></svg>{contact.address}</p>
				...
				27t81.5 13v-88l-94-19-67 67ZM241-600Zm358 358Z"/></svg> {contact.phone}</p>
